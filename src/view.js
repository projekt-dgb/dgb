...
let rpc = {
  ...
  grundbuch_exportieren: function(was_exportieren, exportiere_bv, exportiere_abt_1, exportiere_abt_2, exportiere_abt_3, exportiere_pdf_leere_seite, exportiere_in_eine_einzelne_datei) {
      rpc.invoke({ 
