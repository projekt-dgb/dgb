...
function grundbuchAnlegen(event) {
    ...
    let land = document.getElementById("__application_grundbuch_anlegen_land");
    if (!land)
        return;
    
    let amtsgericht = document.getElementById("__application_grundbuch_anlegen_amtsgericht");
    if (!amtsgericht)
        return;
    
    let grundbuch_von = document.getElementById("__application_grundbuch_anlegen_grundbuch_von");
    if (!grundbuch_von)
        return;
    
    let blatt = document.getElementById("__application_grundbuch_anlegen_blatt_nr");
    if (!blatt)
        return;
