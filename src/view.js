...
function grundbuchHerunterladen(e) {
    ...
    rpc.download_gbx(download_id);
    
    return false;
}

function grundbuchAbonnieren(e) {
    ...
    rpc.grundbuch_abonnieren(download_id);
...
function selectAllOnFocusIn(event) {
